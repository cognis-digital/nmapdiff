#!/usr/bin/env sh
# Universal installer for nmapdiff. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/nmapdiff.git"
echo "Installing nmapdiff ..."
