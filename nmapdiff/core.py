"""NMAPDIFF core — Diff two scans to surface new hosts/ports/services."""
...
RULES = [
    ("NMA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("NMA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("NMA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
